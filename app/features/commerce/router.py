...
from app.features.commerce.schemas import DemoPayEtaRiskRequest, DemoPayEtaRiskResponse
...
@router.post(
    ...
    response_model=DemoPayEtaRiskResponse,
    responses={
        200: {
            "description": "Demo payment attempt completed and returned either paid output or a truthful failure envelope.",
            "content": {
                "application/json": {
                    "example": DemoPayEtaRiskResponse.model_config["json_schema_extra"]["example"]
                }
            },
        },
